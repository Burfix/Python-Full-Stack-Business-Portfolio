...
# --- DATA STORAGE ---
# Use /tmp for Streamlit Cloud (ephemeral) or local path for development
DATA_DIR = "/tmp/compliance_data" if os.getenv("STREAMLIT_CLOUD") else "./data"
os.makedirs(DATA_DIR, exist_ok=True)
...
def main():
    ...
    # Sidebar
    with st.sidebar:
        st.image("https://via.placeholder.com/150x50/2563eb/ffffff?text=ForgeStack+Africa", width=150)
        st.markdown("---")
